...
//   );
// }
import { Box, Button, Card, CardContent, Divider, Grid, Stack, Tab, Tabs, Typography, TextField } from '@mui/material';
import SchoolIcon from '@mui/icons-material/School';
import VolunteerActivismIcon from '@mui/icons-material/VolunteerActivism';
import PersonIcon from '@mui/icons-material/Person';
import BusinessIcon from '@mui/icons-material/Business';
...
export default function SignIn() {
  const [tab, setTab] = useState(0);
  const [orgType, setOrgType] = useState(null); // school or ngo
            ...
            <Stack spacing={3}>
              ...
              {tab === 0 && (
                <Stack spacing={2}>
                  ...
                  <TextField label="Username/ema" fullWidth />
              ...
              {tab === 1 && !orgType && (
                <Stack spacing={3}>
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={12} sm={6}>
                      <Box sx={{ p: 2, border: '1px solid', borderColor: 'divider', borderRadius: 2, cursor: 'pointer' }}
